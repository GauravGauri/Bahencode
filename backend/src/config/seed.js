...
const seedData = async () => {
  try {
    ...
    // 2. Clear existing categories and products to enforce correct hierarchical references
    console.log('Clearing old categories and products to build nested hierarchy...');
